                                ...
                                while($rows = mysqli_fetch_assoc($result))
                                    {
                                      ...
                                      ?>
                                        ...
                                        <a href="<?php echo "http://www.manticore.uni.lodz.pl/~acdc000/"; ?>admin/update-password.php?id=<?php echo $id;?>" class="btn-primary">change password</a>
                                        <a href="<?php echo "http://www.manticore.uni.lodz.pl/~acdc000/"; ?>admin/update-admin.php?id=<?php echo $id;?>" class="btn-secondary">Update admin</a>
                                        <a href="<?php echo "http://www.manticore.uni.lodz.pl/~acdc000/"; ?>admin/delete-admin.php?id=<?php echo $id; ?>" class="btn-danger">Delete admin</a>
