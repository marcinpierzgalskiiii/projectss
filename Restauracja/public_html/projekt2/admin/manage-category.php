...
<div class="main-content">
    <div class="wrapper">
        ...
        <h1>Manage Category</h1>
                ...
                <a href="<?php echo "http://www.manticore.uni.lodz.pl/~acdc000/projekt2/";?>admin/add-category.php" class="btn-primary">Add category</a>
                            ...
                            ?>
                                ...
                                <tr>
                                        ...
                                        <td>
                                            <?php 
                                                ...
                                                if($image_name!= "")
                                                {
                                                    ...
                                                    <img src="<?php echo "http://www.manticore.uni.lodz.pl/~acdc000/projekt2/";?>images/category/<?php echo $image_name;?>" width="100px" >
                                        ...
                                        <td>
                                            ...
                                            <a href="<?php echo "http://www.manticore.uni.lodz.pl/~acdc000/projekt2/"; ?>admin/update-category.php?id=<?php echo $id; ?>" class="btn-secondary">Update Category</a>
                                            <a href="<?php echo "http://www.manticore.uni.lodz.pl/~acdc000/projekt2/"; ?>admin/delete-category.php?id=<?php echo $id; ?>&image_name=<?php echo $image_name;?>" class="btn-danger">Delete Category</a>
